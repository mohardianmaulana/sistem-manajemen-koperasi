                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        max="100"
                                        value="{{ old('persen_jasa_simpanan') }}"
                                        placeholder="0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        max="100"
                                        value="{{ old('persen_jasa_pinjaman') }}"
                                        placeholder="0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        max="100"
                                        value="{{ old('persen_dana_cadangan') }}"
                                        placeholder="0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        max="100"
                                        value="{{ old('persen_jasa_pengurus') }}"
                                        placeholder="0">
...
<div
    ...
    Total Persentase : <strong id="total_persen">0%</strong>
...
function hitungSHU()
{
    ...
    if(totalPersen == 100)
    {
        ...
        document
            .getElementById('statusPersentase')
            .innerHTML =
            '<strong>Total Persentase : 100% ✓</strong>';
