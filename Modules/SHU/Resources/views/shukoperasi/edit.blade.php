...
@section('content_header')
    <h1 class="m-0 text-dark">Edit SHU Koperasi</h1>
@stop
    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4>Form Edit SHU Koperasi</h4>

                <form action="{{ route('shu-koperasi.update', $shu->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="dana_cadangan"
                                    name="dana_cadangan"
                                    value="{{ old('dana_cadangan', $shu->dana_cadangan) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <label>Jasa Pengurus</label>

                                <input
                                    type="number"
                                    id="jasa_pengurus"
                                    name="jasa_pengurus"
                                    value="{{ old('jasa_pengurus', $shu->jasa_pengurus) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    id="dana_sosial"
                                    name="dana_sosial"
                                    value="{{ old('dana_sosial', $shu->dana_sosial) }}"
...
function hitungTotalShu(){
    ...
    document.getElementById('total_shu').value =
        jasaSimpanan +
        jasaPinjaman +
        cadangan +
        pengurus +
